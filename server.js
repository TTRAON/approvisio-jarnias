...
// Fallbacks PNG -> renvoyer le SVG (les navigateurs modernes acceptent le SVG comme icône ; PNG optionnels si déposés dans public/)
app.get(['/pwa-icon-192.png', '/pwa-icon-512.png'], (req, res, next) => {
  // si un vrai PNG existe dans public/, express.static l'aura déjà servi ; sinon on renvoie le SVG
